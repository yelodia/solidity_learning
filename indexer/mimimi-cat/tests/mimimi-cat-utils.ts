...
export function createMintEvent(
  ...
  mintEvent.parameters.push(
    new ethereum.EventParam("freeMint", ethereum.Value.fromBoolean(freeMint))
  )
...
export function createSetStateEvent(state: i32): SetState {
  let setStateEvent = changetype<SetState>(newMockEvent())

  setStateEvent.parameters = new Array()

  setStateEvent.parameters.push(
    new ethereum.EventParam(
      "state",
